...
public class SummonedMummy extends AbstractGaiaEntity implements MagicSummon {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
                .add(AttributeRegistry.BLOOD_MAGIC_RESIST.get(), 1.50f)
                .add(Attributes.MAX_HEALTH, (double)40.0F).add(Attributes.FOLLOW_RANGE, (double)20.0F).add(Attributes.MOVEMENT_SPEED, (double)0.25F).add(Attributes.ATTACK_DAMAGE, (double)4.0F).add(Attributes.ARMOR, (double)4.0F).add(Attributes.KNOCKBACK_RESISTANCE, (double)0.5F).add((Attribute) ForgeMod.STEP_HEIGHT_ADDITION.get(), (double)1.0F);
    }
    ...
    public boolean doHurtTarget(Entity entityIn) {
        if (Utils.doMeleeAttack(this, entityIn,
            ...
            if (entityIn instanceof LivingEntity) {
                ...
                if (effectTime > 0) {
                    livingEntity.addEffect(new MobEffectInstance(BLIGHT.get(), effectTime * 20, 0));
                }
            }
        ...
        if (this.level().getDifficulty() != Difficulty.PEACEFUL) {
            ...
            if (id == 0) {
                ...
                if (mite != null) {
                    ...
                    mite.finalizeSpawn((ServerLevel)this.level(), this.level().getCurrentDifficultyAt(this.blockPosition()), MobSpawnType.MOB_SUMMONED, (SpawnGroupData)null, (CompoundTag)null);
