...
public class FlamingStrikeMobAttackGoal extends Goal {
    ...
    protected void checkAndPerformAttack(LivingEntity target) {
        if (this.canPerformAttack(target)) {
            ...
            // 10% 几率触发圣击
            if (this.mob.getRandom().nextDouble() < this.criticalStrikeChance && this.mob instanceof MagicSummon magicSummon) {
    ...
    protected void performFlamingStrike(PathfinderMob entity) {
        ...
        FlameStrike flameStrike = new FlameStrike(level, true);
