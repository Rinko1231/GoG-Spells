...
public class SummonedWerecat extends AbstractGaiaEntity implements MagicSummon {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes()
                .add(AttributeRegistry.EVOCATION_MAGIC_RESIST.get(), 1.25f)
                .add(Attributes.MAX_HEALTH, (double) 40.0F)
                .add(Attributes.FOLLOW_RANGE, (double) 40.0F).add(Attributes.MOVEMENT_SPEED, (double) 0.25F).add(Attributes.ATTACK_DAMAGE, (double) 4.0F).add(Attributes.ARMOR, (double) 4.0F).add(Attributes.KNOCKBACK_RESISTANCE, 0.3).add((Attribute) ForgeMod.STEP_HEIGHT_ADDITION.get(), (double) 1.0F);
    }
