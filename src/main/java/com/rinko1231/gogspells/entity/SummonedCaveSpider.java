...
public class SummonedCaveSpider extends CaveSpider implements MagicSummon {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, (double)12.0F).add(Attributes.FOLLOW_RANGE, (double)20.0F).add(Attributes.MOVEMENT_SPEED, 0.3).add((Attribute) ForgeMod.STEP_HEIGHT_ADDITION.get(), (double)1.0F).add(Attributes.ATTACK_DAMAGE, (double)6.0F);
    }
}
