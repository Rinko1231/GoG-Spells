...
public class SummonedYukiOnnaRenderer extends GaiaBabyMobRenderer<SummonedYukiOnna, SummonedYukiOnnaModel> {
    public static final ResourceLocation[] YUKI_ONNA_LOCATIONS = new ResourceLocation[]{new ResourceLocation("grimoireofgaia", "textures/entity/yuki_onna/yuki_onna.png")};
