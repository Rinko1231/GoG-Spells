...
public class SummonedSludgeGirlModel extends EntityModel<SummonedSludgeGirl> implements HeadedModel, ArmedModel {
    ...
    public SummonedSludgeGirlModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bodybottom = sludge_girl.addOrReplaceChild("bodybottom", CubeListBuilder.create().texOffs(0, 30).addBox(-3.0F, -1.5F, -1.5F, 6.0F, 3.0F, 3.0F).texOffs(84, 4).addBox(-4.0F, -2.0F, -2.0F, 8.0F, 8.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -13.5F, 0.0F, 0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition head = neck.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -6.0F, -3.0F, 6.0F, 6.0F, 6.0F).texOffs(36, 0).addBox(-3.5F, -6.5F, -3.5F, 7.0F, 7.0F, 7.0F).texOffs(84, 0).addBox(-3.0F, -7.0F, -4.0F, 2.0F, 2.0F, 2.0F).texOffs(84, 0).addBox(1.0F, -7.0F, -4.0F, 2.0F, 2.0F, 2.0F).texOffs(36, 14).addBox(-4.5F, -7.5F, -4.5F, 9.0F, 9.0F, 9.0F), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition headtop = head.addOrReplaceChild("headtop", CubeListBuilder.create().texOffs(72, -6).addBox(0.0F, -12.5F, -5.5F, 0.0F, 7.0F, 6.0F).texOffs(72, 7).addBox(-1.0F, -10.5F, -6.5F, 2.0F, 2.0F, 2.0F), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        leftleg.addOrReplaceChild("leftleglower", CubeListBuilder.create().texOffs(24, 19).mirror().addBox(-1.495F, 6.0F, -1.5F, 3.0F, 7.0F, 3.0F).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
        return LayerDefinition.create(meshdefinition, 128, 64);
    }

    public void prepareMobModel(SummonedSludgeGirl sludgeGirl, float limbSwing, float limbSwingAmount, float partialTick) {
        super.prepareMobModel(sludgeGirl, limbSwing, limbSwingAmount, partialTick);
        this.chest.visible = !(Boolean) GaiaConfig.CLIENT.genderNeutral.get() && !sludgeGirl.isBaby();
    }

    public void setupAnim(SummonedSludgeGirl sludgeGirl, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.headeyes.visible = ageInTicks % 60.0F == 0.0F && limbSwingAmount <= 0.1F;
        this.head.yRot = netHeadYaw / (180F / (float)Math.PI);
        this.head.xRot = headPitch / (180F / (float)Math.PI);
        this.headslime1.yRot = this.head.yRot;
        this.headslime1.xRot = this.head.xRot;
        this.headslime2.xRot = this.head.xRot * 0.75F;

        for(int k = 1; k < 2; ++k) {
            this.headtop.zRot = Mth.cos(((float)k * 1.5F + ageInTicks) * 0.1F) / 16.0F;
        }
