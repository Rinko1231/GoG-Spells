...
public class SummonedSludgeGirlRenderer extends MobRenderer<SummonedSludgeGirl, SummonedSludgeGirlModel> {
        public static final ResourceLocation[] SLUDGE_GIRL_LOCATIONS = new ResourceLocation[]{new ResourceLocation("grimoireofgaia", "textures/entity/sludge_girl/sludge_girl01.png"), new ResourceLocation("grimoireofgaia", "textures/entity/sludge_girl/sludge_girl02.png"), new ResourceLocation("grimoireofgaia", "textures/entity/sludge_girl/sludge_girl03.png")};
