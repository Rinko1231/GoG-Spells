...
public class SummonedArachneRenderer extends MobRenderer<SummonedArachne, SummonedArachneModel> {
    public static final ResourceLocation[] ARACHNE_LOCATIONS = new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath("grimoireofgaia", "textures/entity/arachne/arachne.png")};
