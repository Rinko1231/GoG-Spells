...
public class SummonedNineTailsRenderer extends MobRenderer<SummonedNineTails, SummonedNineTailsModel> {
        public static final ResourceLocation[] NINE_TAILS_LOCATIONS = new ResourceLocation[]{new ResourceLocation("grimoireofgaia", "textures/entity/nine_tails/nine_tails.png")};
