...
public class SummonedWerecatRenderer extends MobRenderer<SummonedWerecat, SummonedWerecatModel> {
        public static final ResourceLocation[] WERECAT_LOCATIONS = new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath("grimoireofgaia", "textures/entity/werecat/werecat01.png"), ResourceLocation.fromNamespaceAndPath("grimoireofgaia", "textures/entity/werecat/werecat02.png")};
