...
public class SummonedEnderDragonGirlRenderer  extends MobRenderer<SummonedEnderDragonGirl, SummonedEnderDragonGirlModel> {
        ...
        public static final ResourceLocation[] ENDER_DRAGON_GIRL_LOCATIONS = new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath("grimoireofgaia", "textures/entity/ender_dragon_girl/ender_dragon_girl.png")};
