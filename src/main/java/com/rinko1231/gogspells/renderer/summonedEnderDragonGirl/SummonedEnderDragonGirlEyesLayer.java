...
public class SummonedEnderDragonGirlEyesLayer  extends EyesLayer<SummonedEnderDragonGirl, SummonedEnderDragonGirlModel> {
        private static final RenderType ENDER_DRAGON_GIRL_EYES = RenderType.eyes(ResourceLocation.fromNamespaceAndPath("grimoireofgaia", "textures/entity/ender_dragon_girl/eyes_ender_dragon_girl.png"));
