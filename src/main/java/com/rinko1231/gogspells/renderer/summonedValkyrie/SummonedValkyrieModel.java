...
public class SummonedValkyrieModel extends EntityModel<SummonedValkyrie> implements HeadedModel, ArmedModel {
    ...
    public SummonedValkyrieModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bodybottom = valkyrie.addOrReplaceChild("bodybottom", CubeListBuilder.create().texOffs(0, 30).addBox(-3.0F, -1.5F, -1.5F, 6.0F, 3.0F, 3.0F).texOffs(96, 0).addBox(-3.5F, -1.0F, -2.0F, 7.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -13.5F, -0.5F, 0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition rightarm = bodytop.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(16, 12).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F).texOffs(64, 23).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 3.0F, 4.0F), PartPose.offsetAndRotation(-2.5F, -4.0F, -1.0F, 0.0873F, 0.0F, 0.1745F));
        PartDefinition rightarmlower = rightarm.addOrReplaceChild("rightarmlower", CubeListBuilder.create().texOffs(16, 20).addBox(-2.005F, 0.0F, -2.0F, 2.0F, 6.0F, 2.0F).texOffs(64, 30).addBox(-2.5F, 0.5F, -2.5F, 2.0F, 6.0F, 3.0F), PartPose.offset(0.0F, 5.0F, 1.0F));
        PartDefinition leftarm = bodytop.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(16, 12).mirror().addBox(0.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F).mirror(false).texOffs(64, 23).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 3.0F, 4.0F).mirror(false), PartPose.offsetAndRotation(2.5F, -4.0F, -1.0F, 0.0873F, 0.0F, -0.1745F));
        ...
        bodytop.addOrReplaceChild("leftwing", CubeListBuilder.create().texOffs(92, 34).mirror().addBox(0.0F, 0.0F, 0.5F, 0.0F, 12.0F, 18.0F).mirror(false), PartPose.offsetAndRotation(2.0F, -5.0F, 0.5F, 0.6981F, 0.5236F, 0.0F));
        ...
        rightleg.addOrReplaceChild("rightleglower", CubeListBuilder.create().texOffs(24, 22).addBox(-1.505F, 0.0F, 0.0F, 3.0F, 7.0F, 3.0F).texOffs(96, 34).addBox(-2.005F, -1.0F, -0.5F, 4.0F, 8.0F, 4.0F, new CubeDeformation(-0.25F)), PartPose.offset(0.0F, 6.0F, -1.5F));
        ...
        leftleg.addOrReplaceChild("leftleglower", CubeListBuilder.create().texOffs(24, 22).mirror().addBox(-1.495F, 0.0F, 0.0F, 3.0F, 7.0F, 3.0F).mirror(false).texOffs(96, 34).mirror().addBox(-1.995F, -1.0F, -0.5F, 4.0F, 8.0F, 4.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offset(0.0F, 6.0F, -1.5F));
        return LayerDefinition.create(meshdefinition, 128, 64);
    }

    public void prepareMobModel(SummonedValkyrie valkyrie, float limbSwing, float limbSwingAmount, float partialTick) {
        super.prepareMobModel(valkyrie, limbSwing, limbSwingAmount, partialTick);
        this.chest.visible = !(Boolean) GaiaConfig.CLIENT.genderNeutral.get() && !valkyrie.isBaby();
    }

    public void setupAnim(SummonedValkyrie valkyrie, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (valkyrie.getAnimationState() == 0) {
            ...
            var10000.zRot += Mth.cos(ageInTicks * 0.09F) * 0.05F + 0.05F + armDefaultAngleZ;
        ...
        float wingDefaultAngleY = ((float)Math.PI / 6F);
        ...
        ModelPart var12 = this.rightwing;
        var12.yRot -= wingDefaultAngleY;
        var12 = this.leftwing;
        var12.yRot += wingDefaultAngleY;
        this.rightleg.xRot = Mth.cos(limbSwing * 0.6662F) * 0.35F * limbSwingAmount;
        this.leftleg.xRot = Mth.cos(limbSwing * 0.6662F + (float)Math.PI) * 0.35F * limbSwingAmount;
