...
public class SummonedValkyrieRenderer extends MobRenderer<SummonedValkyrie, SummonedValkyrieModel> {
    public static final ResourceLocation[] VALKYRIE_LOCATIONS = new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath("grimoireofgaia", "textures/entity/valkyrie/valkyrie.png")};
