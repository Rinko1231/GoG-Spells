...
public class SummonedMummyRenderer extends MobRenderer<SummonedMummy, SummonedMummyModel> {
    public static final ResourceLocation[] MUMMY_LOCATIONS = new ResourceLocation[]{ResourceLocation.fromNamespaceAndPath("grimoireofgaia", "textures/entity/mummy/mummy.png")};
